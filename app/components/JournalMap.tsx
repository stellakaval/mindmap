...
import { MapPin, Trash2, Search, Filter, Calendar } from "lucide-react";
    ...
    map.current.on("load", () => {
      map.current!.on("click", (e) => {
        ...
        const newPopup = new mapboxgl.Popup({
          ...
          .setLngLat([e.lngLat.lng, e.lngLat.lat])
          .setHTML('<div id="popup-content">New Entry</div>')
          .addTo(map.current!);
  ...
  return (
    <div className="flex h-screen w-screen">
      <div className="w-96 h-full overflow-y-auto bg-white shadow-lg p-6">
        ...
        <div className="mt-4">
          <h3 className="font-bold mb-2 text-black">Recent Entries</h3>
          {entries
            .sort(
